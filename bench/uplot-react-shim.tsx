/**
 * Local shim for the uPlot React wrapper.
 * Avoids importing directly from reference/uplot-wrappers/react/ which has a
 * circular tsconfig.json that breaks esbuild/Vite.
 */
