...
export default function CursorBind() {
  ...
  return (
    <div>
      <div className="mb-4">
        <Chart width="auto" height={200} data={data1} syncCursorKey="bind" xlabel="Index" ylabel="Temperature">
          <Series group={0} index={0} label="Temp (C)" />
          <Legend />
        </Chart>
      </div>
      <Chart width="auto" height={200} data={data2} syncCursorKey="bind" xlabel="Index" ylabel="Humidity">
