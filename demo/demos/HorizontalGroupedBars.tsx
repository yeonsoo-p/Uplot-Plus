  ...
  return (
    <div>
      <Chart width="auto" height={500} data={data} title="Grouped Horizontal Bars" ylabel="Sales">
        ...
        <Series group={0} index={0} stroke="#2980b9" label="Product A" paths={horizontalGroupedBars(0, 3)} />
        <Series group={0} index={1} stroke="#27ae60" label="Product B" paths={horizontalGroupedBars(1, 3)} />
        <Series group={0} index={2} stroke="#e67e22" label="Product C" paths={horizontalGroupedBars(2, 3)} />
        <Legend />
      </Chart>
    </div>
  );
